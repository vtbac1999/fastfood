	<?php
		...
		if(isset($_GET['id']) && $_GET['id']!=null)
		{
			...
			list($matt, $tieude, $noidung, $thoigiandang, $hinhanh, $manv, $tinhtrang)=mysqli_fetch_array($result_item,MYSQLI_NUM);
		}else{
			header('location:quanlybaiviet.php');
		}
	?>
		<div id="mid">
			<div class="row" style="width: 100%;">
				...
				<?php
					...
					{
					    $khoa=$_POST['khoa'];
					    $query_tk="UPDATE tintuc SET tinhtrang='".$khoa."' WHERE matt=".$_GET['id'];
