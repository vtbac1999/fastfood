<?php
	...
	if(mysqli_num_rows($result_item)>=1)
	{
		...
		$query_tk="INSERT INTO khachhang(taikhoan,email,matkhau,hoten,ngaysinh,gioitinh,dienthoai,diachi,trangthai,vaitro) VALUES('$taikhoan','$email','$matkhau',N'$hoten','$ngaysinh',N'$gioitinh','$dienthoai',N'$diachi',1,$vaitro)";
